        ...
        <div className='flex  items-center gap-2  '>
          {project?.userId ? (
            user?.id !== project?.userId ? (
              <>
                <ReportModal postId={project._id} type='project' userId={user?.id} setOpenPopover={setOpenPopover}>
          ...
          <LikeContainer itemId={params.id} type='project' totalLike={totalLike} setTotalLike={setTotalLike} />
        </div>
      </div>{' '}
      ...
      <div className='flex  justify-center w-full  bg-white'>
        {project ? (
          <div className='w-[55rem] mt-4 pb-2'>
            ...
            {user && project ? <ProjectCommentContainer user={user} project={project} /> : <></>}
          </div>
        ) : (
          ...
          <div className='flex flex-col p-2'>
            {project ? (
              <div className='flex flex-col gap-2 w-full'>
                <div className='flex w-full justify-between'>
                  <p className='text-left text-[1rem] font-medium text-gray-400'>Số tiền đã nhận được :</p>
                ...
                <div className='flex w-full justify-between'>
                  <p className='text-left text-[1rem] font-medium text-gray-400'>Số tiền mong muốn :</p>
                  <p className='text-right text-[1rem] font-medium text-red'>
                    {project.goal
