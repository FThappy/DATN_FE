...
const SideMessLeft = (props: Props) => {
  ...
  return (
    <div className='w-[22%] laptop:h-[39.5rem] flex flex-col p-2 border-r-gray-300 border-r-2 desktop:[53rem]'>
      ...
      <form onSubmit={handleSearch} className='flex py-2 bg-gray-300 rounded-[12px] mb-1'>
        <button type='submit' className='w-[3rem] h-[2rem]  flex items-center justify-center outline-none'>
          <IoIosSearch size={28} />
        </button>
        <input
          type='text'
