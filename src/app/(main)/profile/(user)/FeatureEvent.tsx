    ...
    <AccordionItem value='item-2' className='border-none outline-none gap-0'>
      <AccordionTrigger className='mb-0 py-0'>
        <div className='w-full h-[60px] cursor-pointer flex items-center gap-1 hover:bg-gray-300 pl-2 rounded-[0.8rem] mb-2'>
          ...
          <p className='font-normal text-[1.2rem] text-slate-800 mr-[1rem]'>Sự kiện</p>
        </div>
      </AccordionTrigger>
      <AccordionContent className='mt-0 px-4'>
        ...
        >
          ...
          <p className='font-normal text-[1.2rem] text-slate-800 mr-[1rem]'>Sự kiện của bạn</p>
        </Link>
        <Link
        ...
        >
          ...
          <p className='font-normal text-[1.2rem] text-slate-800 mr-[1rem]'>Đăng ký tham gia</p>
        </Link>
      </AccordionContent>
    </AccordionItem>
  );
