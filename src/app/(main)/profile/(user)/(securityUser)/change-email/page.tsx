...
const Page = (props: Props) => {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement> | React.MouseEvent<HTMLButtonElement>) => {
  ...
  if (!user) {
    ...
    return userInfo ? (
        ...
        <div className='shadow-beautiful w-full h-screen flex flex-col bg-white rounded-[8px] items-center'>
          {!tokenChange ? (
            ...
            <div className='flex flex-col w-[60%] items-center mt-8'>
              <p className={` font-bold text-red text-[5rem] mt-4 mb-2`}>Thay đổi email</p>
              <p>Vui lòng không tải lại trang trong quá trình này nếu không làm lại từ đầu</p>
      ...
      `}
            ...
            <div className='flex flex-col w-[60%] items-center mt-8'>
              <p className={`font-bold text-red text-[5rem] mt-4 mb-2`}>Xác thực email mới</p>
              <form
      ...
      `}
              ...
              <p className='text-black mt-4'>Chúng tôi đã gửi otp đến email : {newMail}</p>
              <button
