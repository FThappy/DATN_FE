  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const dataSend: DataSend = {
        displayName: displayName !== userInfo?.displayname ? displayName : undefined,
    ...
    return userInfo ? (
      <div className='p-2 w-5/6 '>
        <div className='shadow-beautiful w-full h-screen flex flex-col bg-white rounded-[8px]'>
          <p className='font-bold text-[1.2rem] px-4 mt-2'>Chỉnh sửa thông tin cá nhân :</p>
          <form onSubmit={handleSubmit} className='flex flex-col w-full items-center justify-center mt-2 gap-2'>
            ...
            <div className='flex gap-2'>
              <div className='flex flex-col w-[24.5rem] gap-1'>
                ...
                <div className='flex w-full gap-2 h-[3rem] rounded-[8px]   border-2'>
                  ...
                  <Popover>
                    <PopoverTrigger asChild className='text-[1.1rem] w-[95%] rounded-r-[8px] outline-none'>
                      <div className={'w-full flex justify-start items-center font-normal h-full outline-none'}>
                        {birth ? format(new Date(birth!), 'dd/MM/yyyy') : <span>Chọn ngày thành lập</span>}
                      </div>
                    </PopoverTrigger>
                    <PopoverContent className='w-auto p-0' align='start'>
                      <Calendar mode='single' selected={birth} onSelect={setBirth} initialFocus />
                    </PopoverContent>
                  </Popover>
                </div>
              </div>
            ...
            <button
              ...
              className={`h-[40px] w-[50rem] mb-2 mt-4 bg-greenPrimary rounded flex justify-center 
