...
const Page = (props: Props) => {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    const old_password = CryptoJS.AES.encrypt(oldPass, process.env.NEXT_PUBLIC_KEY_AES).toString();
    const new_password = CryptoJS.AES.encrypt(newPass, process.env.NEXT_PUBLIC_KEY_AES).toString();
        ...
        <div className='shadow-beautiful w-full h-screen flex flex-col bg-white rounded-[8px] items-center'>
          {!tokenChange ? (
            ...
            <div className='flex flex-col w-[60%] items-center mt-8'>
              ...
              <form onSubmit={handleSubmit} className='gap-1 flex flex-col justify-center items-center w-full'>
