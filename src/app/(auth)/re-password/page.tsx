...
const RePassword = () => {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const _password = CryptoJS.AES.encrypt(password, process.env.NEXT_PUBLIC_KEY_AES).toString();
  ...
  return (
    <div className='flex flex-col w-[60%] items-center mt-8'>
      <p className={`${dancing.className} font-bold text-red text-[5rem] mt-4 mb-2`}>Thay đổi lại mật khẩu</p>
