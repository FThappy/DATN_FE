...
const ForgotPassWordPage = () => {
  ...
  return (
    <div className='flex flex-col w-[60%] items-center mt-8'>
      <p className={`${dancing.className} font-bold text-red text-[5rem] mt-4 mb-2`}>Thay đổi mật khẩu</p>

      <form action={handleForgotPassword} className='gap-2 flex flex-col justify-center items-center w-full'>
