  ...
  return (
    <Popover>
      ...
      <PopoverContent className='mr-4 w-[25rem] h-[calc(100vh-8rem)] z-[100] p-2 flex flex-col gap-2'>
        <form onSubmit={handleSearch} className='flex py-2 bg-gray-300 rounded-[12px]'>
          <button type='submit' className='w-[4rem] h-[2rem] p-2 flex items-center justify-center'>
            <IoIosSearch size={28} />
          </button>
          <input
            type='text'
