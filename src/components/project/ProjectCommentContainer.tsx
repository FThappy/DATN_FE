  ...
  return (
    <div className='w-full  shadow-beautiful rounded-[0.5rem]	bg-white p-2 mt-4 mb-2 max-h-[50rem] overflow-y-scroll'>
      <div className='flex w-full gap-2 mb-2'>
        <FaComments size={24} />
        <p className='text-left text-[1.5rem] font-medium text-black'>Bình luận :</p>
      </div>
      <div className='flex w-full gap-2 p-1 px-2 pr-4 h-auto pt-0'>
        ...
        >
          ...
          <button type='submit' className='flex justify-end items-center h-full my-1' disabled={content ? false : true}>
