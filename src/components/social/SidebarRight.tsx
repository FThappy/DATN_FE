      ...
      <div className='fixed w-1/4 px-2 overflow-y-scroll  h-[36rem]'>
        <div className='flex justify-between mb-2 w-full px-2'>
          ...
          >
            ...
            />
            <button type='submit' className='w-[2rem] h-[2rem] p-2 flex items-center justify-center'>
              <IoIosSearch size={20} />
            </button>
          </form>
        </div>
        {qSearch ? (
          <>
            ...
            {endFriendSearch ? (
              ...
              <p className='text-center text-[1.5rem] my-4 text-gray-400 font-bold'>- Đã hết danh sách tìm kiếm -</p>
            )}
          </>
        ) : (
          <>
            ...
            {endFriend ? (
              ...
              <p className='text-center text-[1.5rem] my-4 text-gray-400 font-bold'>- Đã hết bạn bè -</p>
            )}
          </>
        )}
      </div>
