...
const OurVolunteers = () => {
  ...
  return (
    <div className='w-full  h-[850px] bg-slate-50 flex flex-col justify-center items-center'>
      <p className={`${dancing.className} font-bold text-red text-4xl mb-4 `}>Những nhà hảo tâm</p>
      <p className={`${inter.className} font-bold text-slate-800 text-4xl  mb-8`}>
        Gặp gỡ
        <TextUnderline chilldren=' nhà hảo tâm' width={300} top='2.3rem' left='0.6rem' />
      </p>
      <p className={`${inter.className}  text-neutral-800  w-[40rem] text-[1.3rem] text-center mb-8`}>
        Những nhà hảo tâm nổi bât có tấm lòng nhân ái và hoạt động từ thiện tích cực, đã đóng góp một phần không nhỏ vào
        sự phát triển và cải thiện đời sống của cộng đồng.
      </p>
            ...
            <div key={index}>
              ...
              >
                ...
                >
                  ...
                  >
                    <Image src='/link.png' alt='link' loading='lazy' height={40} width={40} />
                  </Link>
                </div>
              </div>
              <div
              ...
              >
                ...
                <p className='text-center text-[1.5rem]  text-white '>Nhà hảo tâm</p>
              </div>
            </div>
          ))}
      </div>
