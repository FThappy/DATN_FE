...
const ContactUs = () => {
  return (
    <div className='w-full h-[950px] bg-cover ' style={{ backgroundImage: 'url(/bg5.jpg)' }}>
      <div className='flex  justify-center items-center gap-8 w-full h-[950px] bg-black/85'>
        <div className='flex w-[640px] h-[600px]'>
          <Image src='/valunteer-left.webp' alt='valunteer-left' loading='lazy' height={85} width={640} className='' />
        </div>
        <div className='flex flex-col self-start'>
          <p className={`${dancing.className} font-bold text-red text-4xl mb-4 mt-8`}>Our Volunteers</p>
          <p className={`${inter.className} font-bold text-white text-4xl  mb-8`}>
            Become A
            <TextUnderline chilldren=' Volunteer' width={300} top='2.3rem' left='0.6rem' />
          </p>
          <p className={`${inter.className}  text-white  w-[40rem] text-[1.3rem]  `}>
