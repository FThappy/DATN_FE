...
const UrgentCause = () => {
  ...
  return (
    <div className='w-full h-[800px] bg-cover ' style={{ backgroundImage: 'url(/bg2.jpg)' }}>
      <div className='flex flex-col items-center w-full h-full bg-orange-50/70 px-[3rem] py-8 '>
        <div className='flex  w-[90rem] h-[650px] mt-10 p-4'>
          <div className=' w-[20rem] '>
            <p className={`${dancing.className} font-bold text-red text-4xl mb-6`}>Dự án thiện nguyện</p>
            <p className={`${inter.className} font-bold text-slate-800 text-4xl leading-[3.8rem] mb-6`}>
            ...
            <p className={`${inter.className}  text-neutral-800 mb-8`}>
              Chung tay là mạng xã hội từ thiện, kết nối các tổ chức, cá nhân, nhà tài trợ và các công ty cùng có mục
              đích từ thiện. Chúng tôi hỗ trợ các dự án, sự kiện từ thiện.
            </p>
            <ButtonHome link='/project' title='Xem tất cả dự án' width='13' color='#F84D42' />
          </div>
