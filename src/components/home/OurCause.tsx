...
const OurCause = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-[820px] bg-slate-200 gap-4">
      ...
      >
        Hãy giúp đỡ những hoàn cảnh và đời sống của các cá nhân hoặc cộng đồng
        có hoàn cảnh khó khăn, mỗi một sự đóng góp nhỏ của các bạn tạo nên một
        con ngưới mới trong tương lai.
      </p>
