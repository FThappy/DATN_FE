    ...
    try {
      ...
      if (dateStart <= new Date() && !(isEqual(dateStart, new Date(event.timeStart)))) {
        ...
        return toastifyUtils(
          "warning",
          "Ngày bắt đầu và kết thúc không hợp lệ 1"
        );
      }
