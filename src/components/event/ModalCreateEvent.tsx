    ...
    <div>
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogTrigger
          ...
          onClick={e => {
            if (!user) {
              toastifyUtils('warning', 'Cần đăng nhập để thực hiện chức năng này');
            }
          }}
        >
        ...
        >
          ...
          <div className='px-4 flex flex-col items-center shadow-beautiful bg-white  w-full rounded-b-[8px] '>
            <button
              ...
              disabled={!user || !eventName || !dateStart || !dateEnd || !city || !address}
              style={{
                backgroundColor:
                  !user || !eventName || !dateStart || !dateEnd || !city || !address ? '#F84D42' : '#20b86d'
              }}
