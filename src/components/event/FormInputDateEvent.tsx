    ...
    <div className='flex w-full items-center gap-2 mt-2'>
      ...
      <Popover defaultOpen>
        <PopoverTrigger className="w-full" >
          <div className='w-full flex border-2 border-gray-400 bg-white items-center h-[4rem]  gap-2 rounded-[12px] p-2 px-4  '>
      ...
      <div className='w-full p-2 px-4 border-2 border-gray-400 rounded-[12px] h-[4rem] flex flex-col '>
