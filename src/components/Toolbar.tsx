    ...
    >
      <div className='flex justify-start items-center gap-2 w-full lg:w-10/12 flex-wrap '>
        ...
        <button
          ...
          className={editor.isActive('bold') ? 'bg-gray-400 p-2 rounded-[8px]' : 'text-black p-2'}
        >
        ...
        <button
          ...
          className={editor.isActive('italic') ? 'bg-gray-400 p-2 rounded-[8px]' : 'text-black p-2'}
        >
        ...
        <button
          ...
          className={editor.isActive('underline') ? 'bg-gray-400 p-2 rounded-[8px]' : 'text-black p-2'}
        >
        ...
        <button
          ...
          className={editor.isActive('strike') ? 'bg-gray-400 p-2 rounded-[8px]' : 'text-black p-2'}
        >
        ...
        <button
          ...
          className={editor.isActive('bulletList') ? 'bg-gray-400 p-2 rounded-[8px]' : 'text-black p-2'}
        >
        ...
        <button
          ...
          className={editor.isActive('orderedList') ? 'bg-gray-400 p-2 rounded-[8px]' : 'text-black p-2'}
        >
        ...
        <ImageToolbar
          ...
          setTmpImg={setTmpImg}
        />
        <LinkToolbar editor={editor} content={content} />
        <button
          onClick={e => {
            e.preventDefault();
