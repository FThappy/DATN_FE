...
const DeleteSure = (props: Props) => {
  ...
  return (
    <div className='flex flex-col justify-center items-center '>
      ...
      <p className='text-[1.2rem] text-gray-400'>Bạn có chắc chắn muốn xóa {type}</p>
      <div className='flex gap-4 justify-center items-center mt-4'>
        <DialogClose asChild>
          <button className='p-2 rounded-[6px] bg-red text-white w-[8rem] cursor-pointer'>Hủy bỏ</button>
        </DialogClose>
        <button
          className='p-2 rounded-[6px] bg-greenPrimaryPrimary text-white w-[8rem] flex justify-center  cursor-pointer'
