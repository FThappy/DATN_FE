      ...
      <div className='w-[80%] h-[12rem] absolute bottom-[-12rem] right-0 flex gap-1 justify-between'>
        ...
        <div className='flex gap-2 justify-center items-center mr-4'>
          ...
          >
            ...
            <div className='flex justify-center gap-2 font-bold text-[1rem] text-white'>Nhắn tin</div>
          </button>
          <BtnHeader user={user} />
          <LikeContainer itemId={user._id} type='user' totalLike={totalLike} setTotalLike={setTotalLike} />
        </div>
      </div>
    </>
  );
