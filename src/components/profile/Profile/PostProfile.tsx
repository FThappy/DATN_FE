...
import { Dialog, DialogTrigger, DialogContentCustom } from '@/components/ui/dialog';
        ...
        <div className='flex gap-2'>
          <Popover open={openPopover} onOpenChange={setOpenPopover}>
            ...
            <PopoverContent className='mr-[12rem] p-1 w-[18rem] px-4'>
              {!post.typeShare ? (
                <UpdatePost post={post} user={user} index={index} setPosts={setPosts} setOpenPopover={setOpenPopover} />
              ) : (
              ...
              <Dialog open={openDeleteModal} onOpenChange={setOpenDeleteModal}>
                ...
                <DialogContentCustom className='rounded-[8px] px-0 py-2 w-[20rem]'>
                  <DeleteSure pending={pending} handleDelete={handleDeletePost} type='bài viết' />
                </DialogContentCustom>
              </Dialog>
            </PopoverContent>
          </Popover>
